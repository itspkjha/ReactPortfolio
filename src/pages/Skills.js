            ...
            <div className="w-[60%] h-[70%] relative">
                ...
                <span className="w-full h-full absolute top-0 z-10 bg-white border-2 border-black custom-font p-7 flex justify-center items-start flex-row rounded-sm">
                    <div className="flex flex-col h-full w-full items-start justify-center">
                        <h1 className=" w-full text-start text-4xl">Fundamental Skills</h1>
                        <div className="flex flex-wrap w-[50%] mt-2 mb-4">
                            <Pills label="DBMS" />
                            <Pills label="OOPS" />
                            <Pills label="Data Structures and Algorithm" />
                        </div>
                        <h1 className=" w-full text-start text-4xl">Languages</h1>
                        <div className="flex flex-wrap w-[50%] mt-2 mb-4">
                            <Pills label="C" />
                            <Pills label="C++" />
                            <Pills label="JS" />
                        ...
                        <h1 className=" w-full text-start text-4xl">Technologies</h1>
                        <div className="flex flex-wrap w-[50%] mt-2 mb-4">
                        ...
                        <h1 className=" w-full text-start text-4xl">Tools</h1>
                        <div className="flex flex-wrap w-[50%] mt-2 mb-4">
                            <Pills label="Git" />
                            <Pills label="Linux" />
                            <Pills label="VS Code" />
